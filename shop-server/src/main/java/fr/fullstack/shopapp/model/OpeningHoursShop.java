...
public class OpeningHoursShop {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "opening_hours_shop_id_seq")
    @SequenceGenerator(name = "opening_hours_shop_id_seq",  sequenceName = "opening_hours_shop_id_seq")
    private long id;
